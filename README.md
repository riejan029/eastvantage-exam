...
This application is a mockup matcher that will generate a profile for you.

How to install and run the application:

1. ) clone the repository from the github:
   https://github.com/riejan029/eastvantage-exam.git

2. ) Open the file directory where you saved/cloned the repository
